...
def train_w2v(behavior_list, adtype, win, negative=5, workers=32, epoch_=8):
    ...
    # train w2v
    model = Word2Vec(size=256, window=win, min_count=1, sg=1, workers=workers, negative=negative)
...
def train_w2v_get_pad(behavior_list,adtype,win,negative=5,workers=32, epoch_=8):
